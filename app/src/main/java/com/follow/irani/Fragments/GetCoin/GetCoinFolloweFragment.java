package com.follow.irani.Fragments.GetCoin;
...
import com.follow.irani.Retrofit.SimpleResult;
import com.follow.irani.Retrofit.Transaction;
import com.follow.irani.Retrofit.UserCoin;
import com.follow.irani.databinding.FragmentGetCoinFollowerBinding;
...
//                        });
    ...
    private void showAuthenticationDialog(){
        AuthenticationDialog authenticationDialog = new AuthenticationDialog(false,null,null);
        authenticationDialog.show(Objects.requireNonNull(getActivity()).getSupportFragmentManager().beginTransaction(),"");
    }
