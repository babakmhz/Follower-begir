...
import ir.novahar.followerbegir.WheelPiclerView.LuckyItem;
import ir.novahar.followerbegir.WheelPiclerView.LuckyWheelView;
...
public class SpecialLuckyWheelPickerDialog extends DialogFragment {
    ...
    private void setStatus(LuckyItem luckyItem) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, App.Base_URL + "transaction/add_coin", response1 -> {
            if (response1 != null) {
                try {
