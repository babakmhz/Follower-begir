package ir.novahar.followerbegir.Fragments.Offers;
...
import ir.novahar.followerbegir.Adapters.OffersAdapter;
...
import ir.novahar.followerbegir.Models.Offers;
...
public class ShopFragment extends Fragment {
    ...
    private void getOffers() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, App.Base_URL + "offer/list", response1 -> {
            if (response1 != null) {
    ...
    private void validateGiftCode() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, App.Base_URL + "check_gift_code", response1 -> {
            if (response1 != null) {
                try {
